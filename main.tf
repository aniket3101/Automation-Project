...
module "rgroup" {
  source          = "./modules/rgroup-N01596244"
  rgroup-name     = "N01596244-RG"
  rgroup-location = "East US"
}

# module for network

module "network" {
  source          = "./modules/network-N01596244"
...
module "common" {
  source          = "./modules/common-N01596244"
...
module "vmlinux" {
  source            = "./modules/vmlinux-N01596244"
  nb_count          = "3"
  linux-vm-name     = "vmlinux-N01596244"
  rgroup-name       = module.rgroup.az-rgroup-name.name
  rgroup-location   = module.rgroup.az-rgroup-location.location
...
module "vmwindows" {
  source         = "./modules/windows-N01596244"
  windows_name   = {
    N01596244-vm1 = "Standard_B1s"
    N01596244-vm2 = "Standard_B1ms"
  }
  win_nb_count     = "1"
  subnet_id        = module.network.azurerm_subnet_name.id
  rgroup-name      = module.rgroup.az-rgroup-name.name
...
module "datadisk" {
  source                   = "./modules/datadisk-N01596244"
  rgroup-name              = module.rgroup.az-rgroup-name.name
  rgroup-location          = module.rgroup.az-rgroup-location.location
...
module "loadbalancer" {
  source           = "./modules/loadbalancer-N01596244"
  rgroup-name      = module.rgroup.az-rgroup-name.name
  rgroup-location  = module.rgroup.az-rgroup-location.location
...
module "database" {
  source      = "./modules/database-N01596244"
  rgroup-name     = module.rgroup.az-rgroup-name.name
  rgroup-location = module.rgroup.az-rgroup-location.location
  depends_on = [
    module.rgroup
